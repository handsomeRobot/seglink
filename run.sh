...
# ==================================== #
python export_inference_graph.py --checkpoint weights/table_extract_0530/model.ckpt-1002 --output_dir inference_graphs/table_extract_0530 --config_file weights/table_extract_0530/train_config.py
